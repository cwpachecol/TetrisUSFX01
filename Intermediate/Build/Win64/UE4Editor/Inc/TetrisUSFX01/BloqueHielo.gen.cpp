...
#include "TetrisUSFX01/BloqueHielo.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	TETRISUSFX01_API UClass* Z_Construct_UClass_ABloqueHielo();
...
// End Cross Module References
...
#endif
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ABloqueHielo_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UBloque_NoRegister, (int32)VTABLE_OFFSET(ABloqueHielo, IBloque), false },
		};
	...
	IMPLEMENT_CLASS(ABloqueHielo, 868557572);
	template<> TETRISUSFX01_API UClass* StaticClass<ABloqueHielo>()
	{
		return ABloqueHielo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABloqueHielo(Z_Construct_UClass_ABloqueHielo, &ABloqueHielo::StaticClass, TEXT("/Script/TetrisUSFX01"), TEXT("ABloqueHielo"), false, nullptr, nullptr, nullptr);
